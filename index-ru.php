...
<head>
    ...
    <!-- Title -->
    <title>История медиации в Украине</title>
</head>
<!-- Body -->

<body>
<?php
    require_once "html-elements/language/headers/header-ru.php";
?>
<!--/.header-->
            ...
            <div class="filters" id="filters">
                <form class="filter__form">
                    <ul>
                        По периодам
                        <li>
                            <label class="container"><span class="filters__label">90-е года</span>
                                <input type="checkbox">
                        ...
                        <li>
                            <label class="container"><span class="filters__label">2014-н.в.</span>
                                <input type="checkbox">
                                <span class="checkmark"></span>
                            </label>
                        </li>
                    ...
                    <ul>
                        По дате
                        <li><input type="text" name="search-date" placeholder="ДД/ММ/ГГГГ" class="search-date"></li>
                        <li><input type="text" name="search-date" placeholder="ДД/ММ/ГГГГ" class="search-date"></li>
                    </ul>
    ...
    <div class="main-content">
        ...
        <div class="articles-search">
            <div class="articles-search__item">
                ...
                <input class="search-input" type="text" placeholder="Введите название статьи или имя автора"></input>
                            ...
                            <ul>
                                <li>
                                    <label class="container-dropdown">
                                        ...
                                        <span class="period-text">90-е года</span>
                                    </label>
                                </li>
                                <li>
                                    <label class="container-dropdown">
                                ...
                                <li>
                                    <label class="container-dropdown">
                                        <input type="checkbox">
                                        <span class="checkmark-dropdown"></span>
                                        <span class="period-text">2014-н.в.</span>
                                    </label>
                                </li>
                            </ul>
                        </ul>
        ...
        <!--/.Filter-Mobile-->
        <!-- Block -->
        <?php require "html-elements/language/articles/article-ru.php"?>
        <!--/.block-->
        <!-- Block -->
        <?php require "html-elements/language/articles/article-ru.php"?>
        <!--/.block-->
        ...
        <div class="articles-pagination">
            ...
            <div onclick="moveButtonChoice(1)" id="forward" class="control-text">Вперёд</div>
        </div>
        <!--/.pagination-->
...
<!-- Footer -->
<?php
    require_once "html-elements/language/footers/footer-ru.php"
?>
<!--/.footer-->
<!-- JavaScript -->
